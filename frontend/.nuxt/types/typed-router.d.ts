...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'customer-user': RouteRecordInfo<'customer-user', '/customer/user', Record<never, never>, Record<never, never>>,
    'customer-user-detail': RouteRecordInfo<'customer-user-detail', '/customer/user/:userid()', { userid: ParamValue<true> }, { userid: ParamValue<false> }>,
